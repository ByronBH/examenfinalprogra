...
import ventas.modelo.daoEmpleados;
...
cbox_estado.addItem("inactivo");
    ...
    public void llenadoDeTablas() {
        ...
        for (int i = 0; i < empleados.size(); i++) {
            ...
            dato[4] = empleados.get(i).getempcargo();
    ...
    public void buscarEmpleados() {
        ...
        txtCargos.setText(empleadoAConsultar.getempcargo());
    ...
    private void initComponents() {
        ...
        txtCargos.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        txtCargos.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(204, 204, 204)));
        txtCargos.setOpaque(false);
        getContentPane().add(txtCargos, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 280, 260, -1));
        ...
        getContentPane().add(cbox_estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 160, 240, -1));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        empleadoAInsertar.setempsueldo(txtCargos.getText());
...
int i =JOptionPane.showConfirmDialog(this, "seguro que quieres modificar este dato ");
        ...
        empleadoAActualizar.setempsueldo(txtCargos.getText());
